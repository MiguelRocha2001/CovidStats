...
val DARK_BLUE = Color(0, 45, 95)
val RED_WITH_TRANSPARENCY = Color(216, 33, 56, 190)
val GREEN_WITH_TRANSPARENCY = Color(0, 161, 115, 190)
val DARK_GREY_WITH_TRANSPARENCY = Color(0, 45, 95, 100)
val DARK_GREY_WITH_TRANSPARENCY2 = Color(0, 45, 95, 140)
//val LIGHT_GREY = Color(191, 191, 191,)
